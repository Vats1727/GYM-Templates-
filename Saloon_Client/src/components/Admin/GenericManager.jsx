                            ...
                            .map(iconName => (
                              <div 
                                ...
                                style={{
                                  ...
                                  border: formData[field.key] === iconName ? '1px solid #7EC8A0' : '1px solid transparent'
                                }}
                                onClick={(e) => {
                                  e.stopPropagation();
                              ...
                              >
                                {React.createElement(LucideIcons[iconName], { size: 16, color: formData[field.key] === iconName ? '#7EC8A0' : '#475569' })}
                              </div>
                            ))}
                        </div>
                      </div>
                    ...
                    <div className="admin-info-row" style={{ background: '#f8fafc', margin: '0', padding: '16px 20px', borderBottom: '1px solid #e2e8f0' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', width: '100%', paddingRight: '28px' }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          {subField && (
                            <p style={{ margin: 0, fontSize: '12px', color: '#7EC8A0', fontWeight: '600', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                              ...
                              <div className="admin-info-row" key={f.key} style={{ flexDirection: 'column', alignItems: 'stretch', padding: '12px 20px' }}>
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                                  {arr.map((item, idx) => {
                                    ...
                                    return (
                                      <span key={idx} style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', background: '#e2f5ec', color: '#7EC8A0', border: '1px solid #a7f3d0', padding: '2px 8px', borderRadius: '6px', fontSize: '10px', fontWeight: '700' }}>
                          ...
                          return (
                            <div className="admin-info-row" key={f.key} style={{ padding: '12px 20px' }}>
                              ...
                              <div style={{ display: 'flex', gap: '2px', alignItems: 'center' }}>
                                ...
                                <span style={{ fontSize: '11px', color: '#64748b', fontWeight: '755', marginLeft: '6px' }}>
                                  {starRating}/5
                                </span>
                              </div>
                            </div>
                          ...
                          return (
                            <div className="admin-info-row" key={f.key} style={{ padding: '12px 20px' }}>
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                                {React.createElement(LucideIcons[displayVal] || LucideIcons.HelpCircle, { size: 14, color: '#7EC8A0' })}
