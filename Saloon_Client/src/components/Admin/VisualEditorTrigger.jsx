...
const VisualEditorTrigger = ({ sectionPath, style = {} }) => {
  ...
  useEffect(() => {
    ...
    if (isActive) {
      parentNode.style.outline = '3px solid #7EC8A0';
      parentNode.style.outlineOffset = '-3px';
      parentNode.style.boxShadow = 'inset 0 0 50px rgba(126, 200, 160, 0.06)';
    } else {
      ...
      {isActive && (
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <button 
            ...
            style={{
              background: 'linear-gradient(135deg, #7EC8A0 0%, #6ab78d 100%)',
              color: '#ffffff',
              borderRadius: '30px',
              padding: '10px 20px',
              fontSize: '12px',
              ...
              boxShadow: '0 12px 30px rgba(126, 200, 160, 0.35)',
