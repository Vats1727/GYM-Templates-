...
const AdminLayout = () => {
  ...
  // Map paths to hash anchors for auto-scroll in saloon preview
  const routeAnchorMap = {
    ...
    '/admin/faq': '#faq',
    '/admin/booked_appointments': '#booking',
    '/admin/footer': '#footer',
  };
  ...
  const navItems = [
    ...
    { title: 'Ticker', path: '/admin/ticker', icon: 'Activity' },
    { title: 'Services', path: '/admin/services', icon: 'Briefcase' },
    { title: 'Work', path: '/admin/work', icon: 'Image' },
    { title: 'Team', path: '/admin/team', icon: 'Users' },
    { title: 'Rewards', path: '/admin/rewards', icon: 'Gift' },
    ...
    { title: 'Appointments', path: '/admin/booked_appointments', icon: 'CalendarCheck' },
    ...
    <div className="admin-container mode-customizer">
        ...
        <div className="modern-sidebar-header">
          <div className="admin-logo-box">
            <div className="logo-icon">
              <LucideIcons.ShieldCheck size={20} color="#7EC8A0" />
            </div>
            <span>Velour Admin</span>
          </div>
          <button 
        ...
        <div className="sidebar-native-outlet-wrapper">
          ...
          {isWideApp && (
            <div style={{ 
              ...
              <div style={{ background: '#e2f5ec', color: '#7EC8A0', padding: '16px', borderRadius: '20px', marginBottom: '20px', display: 'flex' }}>
                <LucideIcons.CalendarCheck size={32} />
              </div>
              <h3 style={{ fontSize: '15px', color: '#0f172a', margin: '0 0 8px', fontWeight: '700' }}>Velour Booking Desk</h3>
      ...
      <style>{`
        ...
        .carousel-card.active .card-icon-container {
          ...
          box-shadow: 0 4px 12px rgba(126, 200, 160, 0.3) !important;
        }
        ...
        .user-avatar {
          ...
          justify-content: center;
          font-weight: 800;
          box-shadow: 0 4px 10px rgba(126, 200, 160, 0.2);
        }
