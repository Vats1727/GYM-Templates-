          ...
          {loading ? (
            ...
            <form onSubmit={handleSave}>
              <h4 style={{ margin: '0 0 18px 0', color: '#0f172a', fontWeight: 800, fontSize: '14px', display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '1px solid #f1f5f9', paddingBottom: '12px' }}>
                <span style={{ background: '#e2f5ec', color: '#7EC8A0', width: '24px', height: '24px', borderRadius: '6px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>✎</span>
              ...
              <div style={{ marginTop: '24px', display: 'flex', gap: '12px', justifyContent: 'flex-end', borderTop: '1px solid #f1f5f9', paddingTop: '16px' }}>
                ...
                <button 
                  ...
                  style={{ padding: '8px 18px', fontSize: '12px', borderRadius: '6px', background: '#7EC8A0', color: '#fff', border: 'none', cursor: 'pointer' }}
                  disabled={isSaving}
                >
