  ...
  return (
    <div className="login-container">
      <div className="login-card">
        <div className="login-header">
          <div className="login-logo">
            <ShieldCheck size={40} color="#7EC8A0" />
          </div>
        ...
        <div className="login-footer">
          <Link to="/forgot-password" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', color: '#7EC8A0', textDecoration: 'none', fontWeight: '600', fontSize: '14px' }}>
      ...
      <style>{`
        ...
        .input-wrapper input:focus { outline: none; border-color: #7EC8A0; background: white; box-shadow: 0 0 0 4px rgba(126, 200, 160, 0.1); }
        .login-btn { width: 100%; padding: 14px; background: #7EC8A0; color: white; border: none; border-radius: 12px; font-size: 15px; font-weight: 700; cursor: pointer; transition: 0.2s; margin-top: 12px; }
        .login-btn:hover { background: #6ab78d; transform: translateY(-1px); }
