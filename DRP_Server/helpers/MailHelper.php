...
class MailHelper {
    ...
    public static function sendThankYouEmail($to, $name) {
        ...
        $message = "
            <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px;'>
                <h2 style='color: #2e6b5e;'>Appointment Booked Successfully!</h2>
                <p>Hello <strong>$name</strong>,</p>
                <p>Thank you for requesting an introductory consultation with Dr. Aisha Malik. We have successfully received your details.</p>
                <p>Dr. Aisha will review your request and get back to you shortly via Email or WhatsApp to confirm the appointment slot.</p>
                <div style='background: #f8fafc; padding: 16px; border-left: 4px solid #2e6b5e; font-size: 14px; color: #1e293b; border-radius: 4px; margin: 20px 0;'>
                    <strong>What's next?</strong><br>
                    Keep an eye on your phone for a WhatsApp message or check your email inbox. We will contact you directly to confirm.
                </div>
                <hr style='border: 0; border-top: 1px solid #e2e8f0; margin: 20px 0;'>
                <p style='color: #94a3b8; font-size: 12px; text-align: center;'>&copy; " . date('Y') . " Dr. Aisha Malik — Holistic Medicine & Online Consulting. All rights reserved.</p>
            </div>
        ";
