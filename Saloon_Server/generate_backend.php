...
$tables = [
    ...
    'services', 'work', 'team', 'rewards', 'products', 'reviews', 'faq', 'bookings',
    'services_heading', 'work_heading', 'team_heading', 'rewards_heading', 'products_heading', 'reviews_heading', 'faq_heading'
];
