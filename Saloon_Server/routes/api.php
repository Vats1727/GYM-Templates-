...
class Router {
    ...
    public function resolve() {
        ...
        if ($method === 'GET') {
            $activeRewrites = [
                '/api/team' => '/api/team/active',
                '/api/services' => '/api/services/active',
                '/api/work' => '/api/work/active',
                '/api/rewards' => '/api/rewards/active',
                '/api/products' => '/api/products/active',
                '/api/reviews' => '/api/reviews/active',
                '/api/faq' => '/api/faq/active',
                '/api/ticker' => '/api/ticker/active',
