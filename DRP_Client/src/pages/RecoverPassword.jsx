    ...
    <div className="login-container">
      <div className="login-card">
        ...
        <div className="login-footer">
          <Link to="/forgot-password" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', color: '#2e6b5e', textDecoration: 'none', fontWeight: '600', fontSize: '14px' }}>
