  ...
  return (
    <div className="login-container">
      <div className="login-card">
        <div className="login-header">
          <div className="login-logo">
            <ShieldCheck size={40} color="#2e6b5e" />
          </div>
        ...
        <form onSubmit={handleSubmit} className="login-form">
          <div className="form-group">
            ...
            <div className="input-wrapper">
              ...
              <input
                type="email"
                placeholder="admin@healnaturally.com"
                value={email}
        ...
        <div className="login-footer">
          <Link to="/login" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', color: '#2e6b5e', textDecoration: 'none', fontWeight: '600', fontSize: '14px' }}>
      ...
      <style>{`
        ...
        .login-logo { width: 72px; height: 72px; background: #e2f5ec; border-radius: 18px; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; }
        ...
        .input-wrapper input:focus { outline: none; border-color: #2e6b5e; background: white; box-shadow: 0 0 0 4px rgba(46, 107, 94, 0.1); }
        .login-btn { width: 100%; padding: 14px; background: #2e6b5e; color: white; border: none; border-radius: 12px; font-size: 15px; font-weight: 700; cursor: pointer; transition: 0.2s; margin-top: 12px; }
        .login-btn:hover { background: #1e4b41; transform: translateY(-1px); }
