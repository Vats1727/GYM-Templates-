                ...
                {field.type === 'textarea' ? (
                    ...
                    >
                      <div style={{ padding: '6px', background: '#fff', borderRadius: '6px', border: '1px solid #e2e8f0', display: 'flex' }}>
                        {(() => {
                          ...
                          return React.createElement(IconComp, { size: 16, color: '#2e6b5e' });
                        })()}
                      </div>
                            ...
                            .map(iconName => (
                              <div 
                                ...
                                style={{
                                  ...
                                  background: formData[field.key] === iconName ? '#e2f5ec' : 'transparent',
                                  border: formData[field.key] === iconName ? '1px solid #2e6b5e' : '1px solid transparent'
                                }}
                                onClick={(e) => {
                                  e.stopPropagation();
                              ...
                              >
                                {React.createElement(LucideIcons[iconName], { size: 16, color: formData[field.key] === iconName ? '#2e6b5e' : '#475569' })}
                              </div>
                            ))}
                        </div>
                      </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12, padding: '16px', background: '#f8fafc', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
                            ...
                            <div key={sch.key} style={{ display: 'flex', flexDirection: 'column', gap: 4, gridColumn: sch.gridColumn || 'span 2' }}>
                              ...
                              {sch.type === 'icon' ? (
                                <div style={{ position: 'relative' }}>
                                  <div 
                                    className="admin-input admin-icon-selector-trigger" 
                                    style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', background: '#f8fafc', padding: 8, borderRadius: 6, border: '1px solid #cbd5e1' }}
                                    onClick={(e) => {
                                      e.stopPropagation();
                                  ...
                                  >
                                    <div style={{ padding: '4px', background: '#fff', borderRadius: '4px', border: '1px solid #e2e8f0', display: 'flex' }}>
                                      {(() => {
                                        const iconName = item[sch.key];
                                        const IconComp = (iconName && LucideIcons[iconName]) ? LucideIcons[iconName] : LucideIcons.HelpCircle;
                                        return React.createElement(IconComp, { size: 14, color: '#2e6b5e' });
                                      })()}
                                    </div>
                                  ...
                                  {activeDropdown === `${field.key}_${idx}_${sch.key}` && (
                                    <div className="icon-dropdown-grid active" style={{ position: 'absolute', top: '100%', left: 0, right: 0, marginTop: '8px', zIndex: 100, background: '#fff', border: '1px solid #cbd5e1', borderRadius: 8, boxShadow: '0 10px 25px rgba(0,0,0,0.1)', padding: 10 }}>
                                      ...
                                      <div className="icon-grid-scroll" style={{ maxHeight: '150px', overflowY: 'auto', display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: 6 }}>
                                        {Object.keys(LucideIcons)
                                          .filter(key => /^[A-Z]/.test(key) && key !== 'Icon' && key !== 'Lucide' && (typeof LucideIcons[key] === 'function' || typeof LucideIcons[key] === 'object'))
                                          .map(iconName => (
                                            <div 
                                              ...
                                              style={{
                                                display: 'flex', justifyContent: 'center', alignItems: 'center', padding: 8, borderRadius: 6, cursor: 'pointer',
                                                background: item[sch.key] === iconName ? '#e2f5ec' : 'transparent',
                                                border: item[sch.key] === iconName ? '1px solid #2e6b5e' : '1px solid transparent'
                                              }}
                                              onClick={(e) => {
                                                e.stopPropagation();
                                            ...
                                            >
                                              {React.createElement(LucideIcons[iconName], { size: 16, color: item[sch.key] === iconName ? '#2e6b5e' : '#475569' })}
                                            </div>
                                          ))}
                                      </div>
                                    </div>
                    ...
                    <button 
                      ...
                      onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#2e6b5e'; e.currentTarget.style.color = '#1e4b41'; }}
                    ...
                    <div className="admin-info-row" style={{ background: '#f8fafc', margin: '0', padding: '16px 20px', borderBottom: '1px solid #e2e8f0' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', width: '100%', paddingRight: '28px' }}>
                        {imageField && item[imageField.key] ? (
                          ...
                          <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: '#e2f5ec', border: '2px solid #fff', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)' }}>
                            {React.createElement(
                              (item[iconField.key] && LucideIcons[item[iconField.key]]) ? LucideIcons[item[iconField.key]] : LucideIcons.User,
                              { size: 20, color: '#2e6b5e' }
                            )}
                          </div>
                        ) : (
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          {subField && (
                            <p style={{ margin: 0, fontSize: '12px', color: '#2e6b5e', fontWeight: '600', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                              ...
                              <div className="admin-info-row" key={f.key} style={{ flexDirection: 'column', alignItems: 'stretch', padding: '12px 20px' }}>
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                                  {arr.map((item, idx) => {
                                    ...
                                    return (
                                      <span key={idx} style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', background: '#e2f5ec', color: '#2e6b5e', border: '1px solid #a7f3d0', padding: '2px 8px', borderRadius: '6px', fontSize: '10px', fontWeight: '700' }}>
                          ...
                          return (
                            <div className="admin-info-row" key={f.key} style={{ padding: '12px 20px' }}>
                              ...
                              <div style={{ display: 'flex', gap: '2px', alignItems: 'center' }}>
                                ...
                                <span style={{ fontSize: '11px', color: '#64748b', fontWeight: '700', marginLeft: '6px' }}>
                                  {starRating}/5
                                </span>
                              </div>
                            </div>
                          ...
                          return (
                            <div className="admin-info-row" key={f.key} style={{ padding: '12px 20px' }}>
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                                {React.createElement(LucideIcons[displayVal] || LucideIcons.HelpCircle, { size: 14, color: '#2e6b5e' })}
