...
const VisualEditorTrigger = ({ sectionPath, style = {} }) => {
  ...
  useEffect(() => {
    ...
    if (isActive) {
      parentNode.style.outline = '3px solid #2e6b5e';
      parentNode.style.outlineOffset = '-3px';
      parentNode.style.boxShadow = 'inset 0 0 50px rgba(46, 107, 94, 0.06)';
    } else {
      ...
      {isActive && (
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <button 
            ...
            style={{
              background: 'linear-gradient(135deg, #2e6b5e 0%, #1e4b41 100%)',
              color: '#ffffff',
              borderRadius: '30px',
              padding: '10px 20px',
              fontSize: '12px',
              ...
              boxShadow: '0 12px 30px rgba(46, 107, 94, 0.35)',
