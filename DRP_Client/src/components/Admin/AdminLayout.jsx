...
const AdminLayout = () => {
  ...
  // Map paths to hash anchors for auto-scroll in doctor portfolio preview
  ...
  const navItems = [
    ...
    { title: 'About Doctor', path: '/admin/about', icon: 'User' },
    { title: 'Treatments', path: '/admin/treatments', icon: 'Activity' },
    { title: 'Case Studies', path: '/admin/case-studies', icon: 'BookOpen' },
    { title: 'How It Works', path: '/admin/how-it-works', icon: 'ListOrdered' },
    ...
    <div className="admin-container mode-customizer">
        ...
        <div className="modern-sidebar-header">
          <div className="admin-logo-box">
            <div className="logo-icon">
              <LucideIcons.ShieldCheck size={20} color="#2e6b5e" />
            </div>
            <span>Dr. Aisha Malik</span>
          </div>
          <button 
        ...
        <div className="sidebar-native-outlet-wrapper">
          ...
          {isWideApp && (
            <div style={{ 
              ...
              <div style={{ background: '#e2f5ec', color: '#2e6b5e', padding: '16px', borderRadius: '20px', marginBottom: '20px', display: 'flex' }}>
                <LucideIcons.CalendarCheck size={32} />
              </div>
              <h3 style={{ fontSize: '15px', color: '#0f172a', margin: '0 0 8px', fontWeight: '700' }}>Aisha Malik Bookings</h3>
      ...
      <style>{`
        ...
        .carousel-card.active .card-icon-container {
          ...
          border-color: #2e6b5e !important;
          color: #ffffff !important;
          box-shadow: 0 4px 12px rgba(46, 107, 94, 0.3) !important;
        }
        ...
        .user-avatar {
          ...
          justify-content: center;
          font-weight: 800;
          box-shadow: 0 4px 10px rgba(46, 107, 94, 0.2);
        }
