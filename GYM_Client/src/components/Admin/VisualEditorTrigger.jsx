...
const VisualEditorTrigger = ({ sectionPath, style = {} }) => {
  ...
  useEffect(() => {
    ...
    if (isActive) {
      parentNode.style.outline = '3px solid var(--accent)';
      parentNode.style.outlineOffset = '-3px';
      parentNode.style.boxShadow = 'inset 0 0 50px rgba(232, 255, 0, 0.05)';
    } else {
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <button 
            ...
            style={{
              ...
              boxShadow: '0 12px 30px rgba(232, 255, 0, 0.25)',
          ...
          >
            <LucideIcons.Pencil size={14} color="var(--bg)" strokeWidth={2.5} />
