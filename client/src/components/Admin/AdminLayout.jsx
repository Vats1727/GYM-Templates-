...
// [START_GENERATED_NAV_ITEMS]
    ...
    { title: 'CTA Section', path: '/admin/cta_section', icon: 'Megaphone' },
    { title: 'Ticker', path: '/admin/ticker', icon: 'Activity' },
    { title: 'Programs', path: '/admin/programs', icon: 'Zap' },
    { title: 'Stats', path: '/admin/stats', icon: 'BarChart' },
    { title: 'Trainers', path: '/admin/trainers', icon: 'Users' },
    { title: 'Pricing', path: '/admin/pricing', icon: 'CreditCard' },
  ...
  return (
    <div className="admin-container mode-customizer">
      ...
      <style>{`
        ...
        /* RESTORE DEFAULT BROWSER CURSOR GLOBALLY IN ADMIN */
