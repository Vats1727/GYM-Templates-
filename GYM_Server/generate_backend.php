...
$tables = [
    'hero_section', 'about_section', 'navbar', 'footer',
...
if (!file_exists(__DIR__ . '/models')) mkdir(__DIR__ . '/models', 0777, true);
if (!file_exists(__DIR__ . '/controllers')) mkdir(__DIR__ . '/controllers', 0777, true);
if (!file_exists(__DIR__ . '/routes')) mkdir(__DIR__ . '/routes', 0777, true);
...
class {$camelCase}Controller {
    ...
    public function create() {
        ...
        if (\$this->model->create(\$data)) {
            ...
            if ("$table" === "bookings" && isset(\$data['email']) && isset(\$data['name']) && isset(\$data['service'])) {
                try {
