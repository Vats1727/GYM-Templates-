<?php
require_once __DIR__ . '/../models/ProcessSteps.php';

class ProcessStepsController {
    private $model;
    public function __construct() {
        $this->model = new ProcessSteps(Database::connect());
    }
    ...
    public function create() {
        ...
        if ($this->model->create($data)) {
            ...
            if ("process_steps" === "bookings" && isset($data['email']) && isset($data['name']) && isset($data['service'])) {
                try {
