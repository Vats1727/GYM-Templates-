<?php
require_once __DIR__ . '/../models/PricingPlansHeading.php';

class PricingPlansHeadingController {
    private $model;
    public function __construct() {
        $this->model = new PricingPlansHeading(Database::connect());
    }
    ...
    public function create() {
        ...
        if ($this->model->create($data)) {
            ...
            if ("pricing_plans_heading" === "bookings" && isset($data['email']) && isset($data['name']) && isset($data['service'])) {
                try {
