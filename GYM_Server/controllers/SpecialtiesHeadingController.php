<?php
require_once __DIR__ . '/../models/SpecialtiesHeading.php';

class SpecialtiesHeadingController {
    private $model;
    public function __construct() {
        $this->model = new SpecialtiesHeading(Database::connect());
    }
    ...
    public function create() {
        ...
        if ($this->model->create($data)) {
            ...
            if ("specialties_heading" === "bookings" && isset($data['email']) && isset($data['name']) && isset($data['service'])) {
                try {
