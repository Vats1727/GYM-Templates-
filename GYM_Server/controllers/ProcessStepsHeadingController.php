<?php
require_once __DIR__ . '/../models/ProcessStepsHeading.php';

class ProcessStepsHeadingController {
    private $model;
    public function __construct() {
        $this->model = new ProcessStepsHeading(Database::connect());
    }
    ...
    public function create() {
        ...
        if ($this->model->create($data)) {
            ...
            if ("process_steps_heading" === "bookings" && isset($data['email']) && isset($data['name']) && isset($data['service'])) {
                try {
