<?php
require_once __DIR__ . '/../models/Transformations.php';

class TransformationsController {
    private $model;
    public function __construct() {
        $this->model = new Transformations(Database::connect());
    }
    ...
    public function create() {
        ...
        if ($this->model->create($data)) {
            ...
            if ("transformations" === "bookings" && isset($data['email']) && isset($data['name']) && isset($data['service'])) {
                try {
