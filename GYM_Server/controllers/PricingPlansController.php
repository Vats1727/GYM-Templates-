<?php
require_once __DIR__ . '/../models/PricingPlans.php';

class PricingPlansController {
    private $model;
    public function __construct() {
        $this->model = new PricingPlans(Database::connect());
    }
    ...
    public function create() {
        ...
        if ($this->model->create($data)) {
            ...
            if ("pricing_plans" === "bookings" && isset($data['email']) && isset($data['name']) && isset($data['service'])) {
                try {
