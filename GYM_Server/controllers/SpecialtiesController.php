<?php
require_once __DIR__ . '/../models/Specialties.php';

class SpecialtiesController {
    private $model;
    public function __construct() {
        $this->model = new Specialties(Database::connect());
    }
    ...
    public function create() {
        ...
        if ($this->model->create($data)) {
            ...
            if ("specialties" === "bookings" && isset($data['email']) && isset($data['name']) && isset($data['service'])) {
                try {
