<?php
require_once __DIR__ . '/../models/TestimonialsHeading.php';

class TestimonialsHeadingController {
    private $model;
    public function __construct() {
        $this->model = new TestimonialsHeading(Database::connect());
    }
    ...
    public function create() {
        ...
        if ($this->model->create($data)) {
            ...
            if ("testimonials_heading" === "bookings" && isset($data['email']) && isset($data['name']) && isset($data['service'])) {
                try {
