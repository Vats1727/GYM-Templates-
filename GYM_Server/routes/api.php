    ...
    public function resolve() {
        ...
        if ($method === 'GET') {
            $activeRewrites = [
                ...
                '/api/specialties' => '/api/specialties/active',
                '/api/transformations' => '/api/transformations/active',
                '/api/pricing_plans' => '/api/pricing_plans/active',
                '/api/testimonials' => '/api/testimonials/active',
                '/api/process_steps' => '/api/process_steps/active',
                '/api/footer' => '/api/footer/active',
                '/api/bookings' => '/api/bookings/active',
                '/api/specialties_heading' => '/api/specialties_heading/active',
                '/api/transformations_heading' => '/api/transformations_heading/active',
                '/api/pricing_plans_heading' => '/api/pricing_plans_heading/active',
                '/api/testimonials_heading' => '/api/testimonials_heading/active',
